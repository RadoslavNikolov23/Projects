...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1678267826569425026, ; hash 0x174a67b248a33082, from name: aot-WorkChronicle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WorkChronicle.dll.so
		ptr null; void* handle (0x0)
	}, ; 36
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 9134059013201829588, ; hash 0x7ec2b24737599ed4, from name: libaot-WorkChronicle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WorkChronicle.dll.so
		ptr null; void* handle (0x0)
	}, ; 230
	...
	%struct.DSOCacheEntry {
		i64 9527472982554711389, ; hash 0x84386232ec4e155d, from name: WorkChronicle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WorkChronicle.dll.so
		ptr null; void* handle (0x0)
	}, ; 239
	...
	%struct.DSOCacheEntry {
		i64 11530779678517586238, ; hash 0xa0058f066155693e, from name: libaot-WorkChronicle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WorkChronicle.dll.so
		ptr null; void* handle (0x0)
	}, ; 294
	...
	%struct.DSOCacheEntry {
		i64 12057344604763224696, ; hash 0xa7544b0915627a78, from name: aot-WorkChronicle
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WorkChronicle.dll.so
		ptr null; void* handle (0x0)
	}, ; 311
	...
	%struct.DSOCacheEntry {
		i64 12642448425389160233, ; hash 0xaf72ffdc3e847729, from name: WorkChronicle.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-WorkChronicle.dll.so
		ptr null; void* handle (0x0)
	}, ; 324
...
@.env.3 = private unnamed_addr constant [37 x i8] c"5e4f9f04-c9d7-4e32-8aa6-756cabf291fa\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.companyname.workchronicle\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [28 x i8] c"libaot-WorkChronicle.dll.so\00", align 16
